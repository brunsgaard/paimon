...
| `protobuf` | Protobuf records decoded with a descriptor set, treated as inserts; set `protobuf.descriptor-set.path` and `protobuf.message-name` (see [Kafka CDC](./kafka-cdc)) |
